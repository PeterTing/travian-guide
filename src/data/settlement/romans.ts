...
export const romans: SettlementTimeline = {
  ...
  keyTips: [
    { zh: '雙隊列不要閒：一邊資源田、一邊建築，任何一邊空著 = 浪費羅馬人優勢。', en: 'Never let either queue sit idle — one for fields, one for buildings. Empty queue = wasted Roman advantage.' },
    { zh: '羅馬人開拓者是三族中最貴的，需要大量糧：前期衝糧田 Lv 5+ 很關鍵。', en: 'Roman Settlers are the most expensive of the 3 beginner tribes — push crop fields to Lv 5+ early.' },
