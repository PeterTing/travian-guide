...
export const teutons: SettlementTimeline = {
  tribe: 'teutons',
  approach: {
    zh: '條頓策略不同：前期 Day 1-2 就蓋軍營 + 訓練 Clubswinger（棍棒兵）掠奪 inactive 鄰居，邊打邊攢資源開二村。條頓英雄被動「加入掠奪時 +20% 搶劫」前 2 週超強。',
  ...
  keyTips: [
    ...
    { zh: '如果鄰居都是活躍玩家沒 inactive 打，就用高盧/羅馬模式（專心蓋田 + 村莊大樓）。', en: 'If no inactive neighbors exist, fall back to Gaul/Roman pattern (pure economy): fields + MB only.' },
  ],
};
