const TRIBES_DATA = {
  ...
  spartans: {
    ...
    strengths: [
      ...
      { zh: "Elpida Rider 防禦力極強（步防 120 / 騎防 90）", en: "Elpida Rider exceptional defense (infantry def 120 / cavalry def 90)" }
    ],
    weaknesses: [
    ...
    units: [
      ...
      },
      {
        ...
        carry: 0,
        upkeep: 3,
        cost: { wood: 525, clay: 260, iron: 790, crop: 130 },
        trainTime: 4800,
        role: { zh: "破壞城牆的攻城器", en: "Wall destruction siege unit" }
      },
      {
        name: { zh: "斯巴達投石機", en: "Ballista" },
        type: "siege",
        attack: 50,
        infantryDef: 60,
        cavalryDef: 10,
      ...
      },
      {
        ...
        carry: 3000,
        upkeep: 1,
        cost: { wood: 5115, clay: 5580, iron: 6045, crop: 3255 },
        trainTime: 90700,
        role: { zh: "建立新村莊", en: "Establishes new villages" }
      }
    ],
